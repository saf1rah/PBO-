...
public class tugas_modul3 {
    ...
    // Class Admin
    public static class Admin extends TUGAS.tugas_modul3.User {
        public Admin() {
            super("admin");
        }
        ...
        private void addStudent() {
            ...
            studentsList.add(new TUGAS.tugas_modul3.Student(nim, nama, fakultas, programStudi));
        ...
        private void displayStudents() {
            ...
            for (TUGAS.tugas_modul3.Student student : studentsList) {
